...
//onst BASE_URL = "https://carsystem-backend.onrender.com/api";
...
export const API_ENDPOINTS = {
  ...
  // Payment endpoints
  PAYMENT: {
    CREATE_ORDER: `${BASE_URL}/v1/razorpay/create-order`,
    VERIFY: `${BASE_URL}/v1/razorpay/verify-payment`,
    DETAILS: (paymentId) => `${BASE_URL}/v1/razorpay/payment-details/${paymentId}`,
  },
