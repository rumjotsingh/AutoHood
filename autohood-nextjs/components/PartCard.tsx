...
export default function PartCard({ part }: PartCardProps) {
  ...
  return (
    <div className="group relative bg-white rounded-2xl shadow-lg overflow-hidden card-hover border border-gray-100">
      ...
      {/* Button outside <Link> — invalid nested interactive content caused React #418 */}
